...
include($_SERVER['DOCUMENT_ROOT'].'/dolibarr/htdocs/theme/'.$conf->theme.'/responsibility/dir_depatment/customers.html');
return;
...
//                var_dump($num_col.' '.$fields[$i]->name.'</br>');
    ...
    $actionfields = array('lastdatecomerc'=>'dir_depatment',  'lastdateservice'=>'service', 'lastdateaccounts'=>'accounts',  'lastdatementor'=>'mentor');
    $fields = $result->fetch_fields();
//        var_dump($showtitle);
//        die();
    if($showtitle) {
