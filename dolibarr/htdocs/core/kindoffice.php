...
$KindOffice = $langs->trans('KindOfOffice');
$NewItem = $langs->trans('NewItem');
$Control = $langs->trans('Control');
$theme = $conf->theme;

llxHeader("",$KindOffice,"");
print_fiche_titre($KindOffice);
$TableParam = array();
...
include($_SERVER['DOCUMENT_ROOT'].'/dolibarr/htdocs/theme/'.$theme.'/kindoffice.html');
